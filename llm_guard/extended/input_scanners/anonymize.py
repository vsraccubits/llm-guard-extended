...
from llm_guard.extended.remote_recognizer import BudRemoteRecognizer
...
from ...input_scanners.anonymize_helpers import (
...
from ...input_scanners.base import Scanner
...
class AnonymizeExtended(Scanner):
    """
    ...
    def __init__(
        ...
        *,
        ...
        # Remote recognizer using instead of transformers recognizer
        ...
        # Using remote recognizer instead of transformers recognizer
        ...
        # BUD Remote Recognizer
        remote_recognizer = BudRemoteRecognizer(
            model=recognizer_conf["DEFAULT_MODEL"],
            supported_entities=self._entity_types,
    ...
    def _anonymize(
        ...
        for pii_entity in sorted_pii_entities:
            ...
            changed_entity = AnonymizeExtended._get_entity_placeholder(
    ...
    def scan(self, prompt: str) -> tuple[str, bool, float]:
        ...
        #     text=AnonymizeExtended.remove_single_quotes(prompt),
